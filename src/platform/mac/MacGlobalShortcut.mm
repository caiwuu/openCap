...
MacGlobalShortcut::MacGlobalShortcut(QObject *parent)
    : QObject(parent), m_eventHandler(nullptr), m_hotKeyRef(nullptr),
      m_registered(false) {
  s_instance = this;
}
...
bool MacGlobalShortcut::registerShortcut(const QKeySequence &shortcut) {
  ...
  switch (qtKey) {
  case Qt::Key_A:
    carbonKeyCode = kVK_ANSI_A;
    break;
  case Qt::Key_B:
    carbonKeyCode = kVK_ANSI_B;
    break;
  case Qt::Key_C:
    carbonKeyCode = kVK_ANSI_C;
    break;
  case Qt::Key_D:
    carbonKeyCode = kVK_ANSI_D;
    break;
  case Qt::Key_E:
    carbonKeyCode = kVK_ANSI_E;
    break;
  case Qt::Key_F:
    carbonKeyCode = kVK_ANSI_F;
    break;
  case Qt::Key_G:
    carbonKeyCode = kVK_ANSI_G;
    break;
  case Qt::Key_H:
    carbonKeyCode = kVK_ANSI_H;
    break;
  case Qt::Key_I:
    carbonKeyCode = kVK_ANSI_I;
    break;
  case Qt::Key_J:
    carbonKeyCode = kVK_ANSI_J;
    break;
  case Qt::Key_K:
    carbonKeyCode = kVK_ANSI_K;
    break;
  case Qt::Key_L:
    carbonKeyCode = kVK_ANSI_L;
    break;
  case Qt::Key_M:
    carbonKeyCode = kVK_ANSI_M;
    break;
  case Qt::Key_N:
    carbonKeyCode = kVK_ANSI_N;
    break;
  case Qt::Key_O:
  ...
  case Qt::Key_S:
    ...
    break;
  case Qt::Key_T:
    carbonKeyCode = kVK_ANSI_T;
    break;
  case Qt::Key_U:
    carbonKeyCode = kVK_ANSI_U;
    break;
  case Qt::Key_V:
    carbonKeyCode = kVK_ANSI_V;
    break;
  case Qt::Key_W:
    carbonKeyCode = kVK_ANSI_W;
    break;
  case Qt::Key_X:
    carbonKeyCode = kVK_ANSI_X;
    break;
  case Qt::Key_Y:
    carbonKeyCode = kVK_ANSI_Y;
    break;
  case Qt::Key_Z:
    carbonKeyCode = kVK_ANSI_Z;
    break;
  default:
  ...
  qDebug() << "注册全局快捷键: 修饰键=" << carbonModifiers
           << "按键码=" << carbonKeyCode;
  ...
  EventHandlerUPP handlerUPP =
      NewEventHandlerUPP((EventHandlerProcPtr)hotKeyHandler);
  OSStatus status = InstallApplicationEventHandler(
      handlerUPP, 1, &eventType, this, (EventHandlerRef *)&m_eventHandler);
  ...
  status = RegisterEventHotKey(carbonKeyCode, carbonModifiers, hotKeyID,
                               GetApplicationEventTarget(), 0, hotKeyRefPtr);
...
// Carbon 事件处理回调函数
int MacGlobalShortcut::hotKeyHandler(void *nextHandler, void *theEvent,
                                     void *userData) {
